...
import { FaTachometerAlt, FaUsers, FaUserTie, FaSignOutAlt, FaHistory, FaEnvelope, FaGraduationCap } from 'react-icons/fa';
...
function AdminLayout({ children }) {
    ...
    const navLinks = [
        ...
        { path: '/admin/alumni', icon: <FaGraduationCap size={16} />, label: 'Alumni Directory' },
